...
from datetime import datetime #importa a data/hora atual do sistema, usada para registrar a data do pedido
...
class Order(Base): #cria a classe Order, que representa uma tabela chamada orders
    ...
    order_date = Column(DateTime, default=datetime.utcnow) #data do pedido / default=datetime.utcnow: se o usuário não informar a data, será usada a data/hora atual automaticamente
